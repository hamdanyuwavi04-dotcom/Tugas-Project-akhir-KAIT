...
const PRODUCTS_DATA = [
    {
        id: 1,
        name: 'Sumatra Gayo Arabica (Green Beans)',
        price: 6.80,
        unit: 'MT',
        minOrder: '1 MT',
        stock: 120,
        ...
        rating: 4.8,
        reviews: 42,
        badge: 'Grade 1 Premium',
        spec: 'Kadar Air: 11-12% | Defect: < 4% | Proses: Wet Hulled',
        desc: 'Kopi Arabika dataran tinggi Gayo yang terkenal dengan body tebal, tingkat keasaman rendah, serta profil aroma rempah dan cokelat yang kuat.',
        icon: '☕',
        image: 'sumatra-gayo.jpg'
    },
    {
        id: 2,
        name: 'Pala Banda Premium (Whole Nutmeg)',
        price: 9.50,
        unit: 'KG',
        minOrder: '500 Kg',
        stock: 85,
        ...
        rating: 4.9,
        reviews: 38,
        badge: 'Sertifikasi Organik',
        spec: 'Kadar Air: < 10% | Ukuran: ABCD Mix | Aflatoksin: Negatif',
        desc: 'Pala asli kepulauan Banda dengan kualitas ekspor terbaik tanpa jamur, memiliki kandungan minyak atsiri tinggi dan aroma aromatik yang tajam.',
        icon: '🟤',
        image: 'pala-banda.jpg'
    },
    {
        id: 3,
        name: 'Cengkeh Maluku (Premium Dried Cloves)',
        price: 8.20,
        unit: 'MT',
        minOrder: '1 MT',
        stock: 60,
        ...
        reviews: 29,
        badge: 'Ekstra Kering',
        spec: 'Kadar Air: < 12% | Benda Asing: < 0.5% | Warna: Cokelat Mengkilap',
        desc: 'Cengkeh kering pilihan dari Maluku yang diproses secara alami di bawah sinar matahari. Memiliki tangkai kokoh, wangi intens, dan kadar eugenol tinggi.',
        icon: '🍂',
        image: 'cengkeh-maluku.jpg'
    },
    {
        id: 4,
        name: 'Lada Hitam Lampung (Black Pepper)',
        price: 4.50,
        unit: 'MT',
        minOrder: '1 MT',
        stock: 200,
        ...
        reviews: 51,
        badge: 'ASTA Quality',
        spec: 'Kadar Air: < 12% | Density: 550-600 g/l | Minyak Atsiri: > 2%',
        desc: 'Lada hitam khas Lampung dengan tingkat kepedasan tajam (piperin tinggi). Diproses melalui pencucian higienis standar ASTA.',
        icon: '⚫',
        image: 'lada-hitam.jpg'
    },
    {
        id: 5,
        name: 'Lada Putih Muntok (White Pepper)',
        price: 6.20,
        unit: 'MT',
        minOrder: '1 MT',
        stock: 95,
        ...
        reviews: 33,
        badge: 'Double Washed',
        spec: 'Kadar Air: < 13% | Warna: Putih Krem Bersih | Piperin: > 5%',
        desc: 'Muntok White Pepper yang terkenal di pasar Eropa. Melewati proses perendaman air mengalir murni menghasilkan lada beraroma khas tanpa bau apek.',
        icon: '⚪',
        image: 'lada-putih.jpg'
    },
    {
        id: 6,
        name: 'Vanili Planifolia Alor (Vanilla Beans)',
        price: 140.00,
        unit: 'KG',
        minOrder: '10 Kg',
        stock: 40,
        ...
        spec: 'Kadar Air: 25-30% | Panjang: 15-20 cm | Vanillin: 2.0-2.5%',
        desc: 'Polong vanili utuh nan eksotis dari Nusa Tenggara Timur. Tekstur fleksibel, berminyak, dengan profil rasa sweet, creamy, dan kompleks.',
        icon: '🌿',
        image: 'vanili-alor.jpg'
    },
    {
        id: 7,
        name: 'Kayu Manis Kerinci (Cassia Vera)',
        price: 5.80,
        unit: 'MT',
        minOrder: '1 MT',
        stock: 75,
        ...
        rating: 4.4,
        reviews: 22,
        badge: 'Grade AA Stick',
        spec: 'Kadar Air: < 12% | Panjang: 8-10 cm / potong | Minyak Atsiri: > 2.5%',
        desc: 'Kayu manis Cassia dari dataran tinggi Gunung Kerinci, Jambi. Dipanen dari pohon berusia di atas 10 tahun untuk rasa manis pedas optimal.',
        icon: '🪵',
        image: 'kayu-manis.jpg'
    },
    {
        id: 8,
        name: 'Toraja Sapan Arabica (Green Beans)',
        price: 7.20,
        unit: 'MT',
        minOrder: '1 MT',
        stock: 50,
        ...
        spec: 'Kadar Air: 11% | Ketinggian: 1400-1800 mdpl | Cupping Score: 84+',
        desc: 'Biji kopi eksklusif dari lereng Sapan, Toraja. Dikenal di Jepang dan Eropa akan profil rasa cokelat hitam, karamel, dengan acidity berry segar.',
        icon: '⛰️',
        image: 'toraja-sapan.jpg'
    },
    {
        id: 9,
        name: 'Kapulaga Jawa (White Cardamom)',
        price: 12.00,
        unit: 'KG',
        minOrder: '500 Kg',
        stock: 110,
        ...
        reviews: 16,
        badge: 'Sun Dried',
        spec: 'Kadar Air: < 14% | Warna: Putih Gading | Benda Asing: < 1%',
        desc: 'Kapulaga lokal (Amomum compactum) yang dikeringkan matahari. Esensial untuk farmasi, jamu tradisional, dan masakan Timur Tengah.',
        icon: '🌱',
        image: 'kapulaga-jawa.jpg'
    },
    {
        id: 10,
        name: 'Jahe Gajah (Fresh/Dried Elephant Ginger)',
        price: 1.80,
        unit: 'MT',
        minOrder: '5 MT',
        stock: 300,
        ...
        reviews: 14,
        badge: 'Big Rhizome',
        spec: 'Ukuran: 150g - 300g up | Proses: Washed & Cleaned | Kemasan: Mesh Bag 30kg',
        desc: 'Rimpang jahe berukuran besar, daging rimpang lebih lunak, dan rasa tidak terlalu pedas. Cocok untuk minuman, ekstrak makanan, atau konsumsi segar.',
        icon: '🫚',
...
function renderProducts() {
    ...
    grid.innerHTML = pageItems.map(p => {
        ...
        // Gunakan gambar jika ada, fallback ke ikon + placeholder
        const imgTag = p.image ? `<img src="images/${p.image}" alt="${p.name}" style="width:100%; height:100%; object-fit:cover; border-radius:0;" />` : 
            `<div class="image-placeholder prod-img-placeholder" style="width:100%; height:180px; border:none; border-radius:0;">
